...
# Assuming you have a session object, replace "your_url_here" with the actual URL
...
# Scraping text content from div elements with class "text_content"
name <- session %>%
  html_nodes("h2") %>%
  html_text()
...
# Extract only the first occurrence of the price with a regular expression
